...
const List<List<String>> statics = [
  ...
  // Ошибка «Стоп» на чистом пути — объект в тупик не попадал.
  ...
  // Единственный объект в матче: без «первого/второго», удвоение сразу.
  ['found_single', 'Правильно! Объект найден. Монеты удвоены!'],
  ['miss_empty', 'Промах! Это была пустая ячейка.'],
  // Супер-игра: тап по второму объекту раньше первого.
